...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [_userBtn setImage:[UIImage imageWithData:[JYUser currentUser].userImg] forState:UIControlStateNormal];
        ...
        
        {
            ...
            [_signatureLabel mas_makeConstraints:^(MASConstraintMaker *make) {
                make.left.right.equalTo(self);
                make.top.equalTo(_signatureLabel.mas_bottom).offset(kWidth(18));
